...
import HardwareSummary from "@/components/hardware/HardwareSummary";
    ...
    useCallback(
      async (
        ...
        try {
          ...
          const json =
            (await response.json()) as HardwareListResponse;
    ...
    useCallback(
      async (
        ...
        try {
          ...
          const json =
            (await response.json()) as HardwareSummaryResponse;
